...
public class Ch10P2HttpFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
	...
	public Ch10P2HttpFileServerHandler(String url) {
		this.url = url;
	}
	...
	private String sanitizeUri(String uri) {
		...
		uri = uri.replace('/', File.separatorChar);
		 ...
		 return System.getProperty("user.dir") + File.separator + "src" + uri;
	}
